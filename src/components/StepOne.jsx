            ...
            <div className="step-one">
                <div className="column-left">
                    ...
                    <div className='section__form--inputs expensas'>
                        ...
                        <input onChange={(e) => setPagaExpensas(true)} type="radio" id="si" name="pagaExpensas" value="si" />
                        <label htmlFor="si">Sí</label>
                        <input onChange={(e) => setPagaExpensas(false)} type="radio" id="no" name="pagaExpensas" value="no" />
